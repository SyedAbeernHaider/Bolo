...
const Navbar = () => (
  <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 z-20 relative">

    <div className="flex items-center gap-2">

      {/* BOLO */}
      <span className="google-sans text-white text-2xl md:text-3xl font-black leading-none">
        BOLO
      </span>

      {/* BY */}
      <span className="google-sans text-white text-sm md:text-base font-semibold leading-none">
        by
      </span>
      ...
      <img
        ...
        alt="Connect Hear"
        className="h-4 md:h-6 w-auto object-contain leading-none"
      />
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-500 to-teal-500 font-sans overflow-hidden relative border-8 border-gray-800">
      ...
      <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-80px)] pt-12 pb-20 text-center">
        ...
        <FloatBubble content="SIGN!" position="top-1/2 left-5 hidden md:block" />
        ...
        <motion.h1
          className="text-center leading-tight mb-4 max-w-4xl mx-auto px-4 filter drop-shadow-2xl"
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.8, type: 'spring', stiffness: 120 }}
        >

          {/* BOLO — Bigger + Google Sans */}
          <span className="google-sans text-white text-7xl md:text-9xl font-black block">
            BOLO
          </span>

          {/* BY + Logo (same total width as BOLO) */}
          <div className="flex items-center justify-center gap-2 mt-2 w-full">

            {/* BY small */}
            <span className="google-sans text-white text-lg md:text-2xl font-semibold">
              by
            </span>

            {/* Logo small but aligned */}
            <img
              src="/logo/CH White Logo.png"
              alt="Connect Hear"
              className="h-3 md:h-10 w-auto object-contain"
            />
          </div>
          <br></br>
        ...
        >
          ...
          Learn to sign your name in 5 minutes!
        </motion.p>
